function activateSnooze() {
  ...
  window.location.href = "dnd-active.html";
}

function endSnoozeAuto() {
...
function endSnoozeManual() {
  chrome.alarms.clear("chrome-dnd-snooze")
  chrome.contentSettings['notifications'].clear({ });
  chrome.browserAction.setIcon({path: 'images\\bell-gray-16.png'});
  chrome.browserAction.setPopup({popup: 'dnd-inactive.html'});
  window.location.href = "dnd-inactive.html";
}
...
if (endItem !== null)
  endItem.addEventListener('click', endSnoozeManual);
